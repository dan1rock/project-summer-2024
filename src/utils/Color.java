...
public class Color {
    ...
    public static final float[] DarkGrey = {0.2f, 0.2f, 0.2f};
    ...
    public static final float[] DarkBlue = {0.0f, 0.0f, 0.5f};
    ...
    public static final float[] Orange = {0.1f, 0.5f, 0.0f};
    public static final float[] Lemon = {0.8f, 1.0f, 0.0f};
    public static final float[] Brown = {0.5f, 0.3f, 0.0f};
    public static final float[] Navy = {0.0f, 0.4f, 0.8f};
    public static final float[] Aqua = {0.4f, 0.7f, 1.0f};
    public static final float[] Cherry = {1.0f, 0.0f, 0.5f};
}
